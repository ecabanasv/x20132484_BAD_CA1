import { NumericType, DecimalType, TypeValueInput, ContractInput, FunctionExternalInput, Uint8ArrayLikeInput, EncodingTextInput } from "./types";
...
export declare function isUint8ArrayLikeInput(input: any): input is Uint8ArrayLikeInput;
